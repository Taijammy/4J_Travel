    ...
    <div className="min-h-screen bg-[#0f0f0f] pb-20 md:pb-8 md:pt-14">
      ...
      <div className="max-w-lg mx-auto px-4 pt-6">
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 mt-0.5">{rides.length} trips · Total earned: ${totalEarned.toFixed(2)}</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-500 text-sm">Go online to start accepting rides</p>
          </div>
        ) : (
